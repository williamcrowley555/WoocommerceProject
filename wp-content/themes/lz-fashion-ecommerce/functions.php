...
function lz_fashion_ecommerce_setup() {
	...
	register_nav_menus( array(
		...
		'responsive'	=> __('Responsive Menu', 'lz-fashion-ecommerce'),
	) );
...
//footer Link
define('LZ_FASHION_ECOMMERCE_CREDIT',__('https://www.luzuk.com/themes/free-fashion-wordpress-theme/','lz-fashion-ecommerce'));

if ( ! function_exists( 'lz_fashion_ecommerce_credit' ) ) {
function lz_fashion_ecommerce_credit(){
	echo "<a href=".esc_url(LZ_FASHION_ECOMMERCE_CREDIT)." target='_blank'>".esc_html__('Ecommerce WordPress Theme','lz-fashion-ecommerce')."</a>";
	}
}
...
function lz_fashion_ecommerce_sanitize_phone_number( $phone ) {
	return preg_replace( '/[^\d+]/', '', $phone );
}

function lz_fashion_ecommerce_sanitize_checkbox( $input ) {
	
	// Boolean check 
	return ( ( isset( $input ) && true == $input ) ? true : false );
}

function lz_fashion_ecommerce_sanitize_email( $email, $setting ) {
