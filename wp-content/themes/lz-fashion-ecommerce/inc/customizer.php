...
function lz_fashion_ecommerce_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('lz_fashion_ecommerce_show_site_title',array(
       'default' => true,
       'sanitize_callback'	=> 'lz_fashion_ecommerce_sanitize_checkbox'
    ));
    $wp_customize->add_control('lz_fashion_ecommerce_show_site_title',array(
       'type' => 'checkbox',
       'label' => __('Show / Hide Site Title','lz-fashion-ecommerce'),
       'section' => 'title_tagline'
    ));

    $wp_customize->add_setting('lz_fashion_ecommerce_show_tagline',array(
       'default' => true,
       'sanitize_callback'	=> 'lz_fashion_ecommerce_sanitize_checkbox'
    ));
    $wp_customize->add_control('lz_fashion_ecommerce_show_tagline',array(
       'type' => 'checkbox',
       'label' => __('Show / Hide Site Tagline','lz-fashion-ecommerce'),
       'section' => 'title_tagline'
    ));
	...
	$wp_customize->add_setting('lz_fashion_ecommerce_call',array(
		'default'=> '',
		'sanitize_callback'	=> 'lz_fashion_ecommerce_sanitize_phone_number'
	));	
	...
	$wp_customize->add_setting('lz_fashion_ecommerce_mail',array(
		'default'=> '',
		'sanitize_callback'	=> 'lz_fashion_ecommerce_sanitize_email'
	));	
		...
		$manager->add_section(
			new LZ_Fashion_Ecommerce_Customize_Section_Pro(
				...
				array(
					...
					'pro_url'  => esc_url( 'https://www.luzuk.com/product/fashion-wordpress-theme/' ),
				)
			)
		);
	}
